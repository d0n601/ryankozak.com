...
![digitalocean](/posts/images/bad-usb-botnet/digitalocean.png)
**Figure 1:** Botnet C&C server droplet on Digital Ocean.

![sheep](/posts/images/bad-usb-botnet/sheep.png)
...
![boot_BYOB](/posts/images/bad-usb-botnet/boot_BYOB.png)
...
![amazon](/posts/images/bad-usb-botnet/amazon.png)
...
![arduino_download](/posts/images/bad-usb-botnet/arduino_download.png)
...
![digistump_json](/posts/images/bad-usb-botnet/digistump_json.png)
**Figure 6:** Add DigiStump board manager url to configuration.

![digistump_boardmanager](/posts/images/bad-usb-botnet/digistump_boardmanager.png)
**Figure 7:** Board manager downloading DigiStump's board libraries.

![digistump_default](/posts/images/bad-usb-botnet/digistump_setboard.png)
...
![payload_generated](/posts/images/bad-usb-botnet/payload_generated.png)
...
![payload_directory](/posts/images/bad-usb-botnet/payload_directory.png)
